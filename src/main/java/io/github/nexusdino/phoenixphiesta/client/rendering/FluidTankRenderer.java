...
// Credits to JEI Common API
public class FluidTankRenderer<T extends FluidStack> implements IIngredientRenderer<T> {
	...
	public void drawFluid(PoseStack poseStack, final int width, final int height, T fluidStack) {
	...
	public List<Component> getTooltip(T fluidStack, TooltipFlag tooltipFlag) {
		...
		Fluid fluidType = type.getBase(fluidStack);
			...
			if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
				MutableComponent amountString = Component.translatable("jei.tooltip.liquid.amount.with.capacity", FORMAT.format(milliBuckets), FORMAT.format(capacity));
				tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
			} else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
				MutableComponent amountString = Component.translatable("jei.tooltip.liquid.amount", FORMAT.format(milliBuckets));
				tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
			}
